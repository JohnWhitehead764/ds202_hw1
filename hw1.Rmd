...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **John** and I am a sophomore in *Data Science*. I was born in Illinois, but I grew up in Iowa and I have lived here since I was 4 years old. In my free time I like to watch movies and tv shows.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: The most important job for a data scientist is to understand the logic thats goes into the statistics, any programmer can write code, bnut if you can't explain any of the data then you can't be a ![data scientist](https://www.google.com/search?q=data+scientist&rlz=1C1CHBF_enUS854US854&source=lnms&tbm=isch&sa=X&ved=2ahUKEwiPh77_073uAhV_B50JHVR_D2QQ_AUoAnoECBQQBA&biw=1536&bih=754#imgrc=oi6cTdC_AL3vYM). 
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am most interested in learning about about the business side of data science and what kind of data they deal with. 
